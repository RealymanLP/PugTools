            ...
            if (visualFqn.Contains(".")) {
              ...
              switch (extension) {
                case ".fxspec":
                  ...
                  break;
                case ".fxp":
                case ".lit": // don't know where these files go.
                case ".gr2":
                case ".mag":
    ...
    */
    ...
    private void ParseGR2(HashSet<string> gr2List, string rawModel) {
      ...
      if (file != null) {
        ...
        using (var fileStream = file.OpenCopyInMemory()) { ReadGR2(fileStream, meshNames, materialNames); }
    ...
    public void ReadGR2(Stream stream, List<string> meshNames, List<string> materialNames) {
      ...
      if (buffer.ToHexString() != "47415742") {
        //Debug.WriteLine("Invalid header" + buffer.ToHexString());
        return;
      } else {
        //Debug.WriteLine("Valid header");
