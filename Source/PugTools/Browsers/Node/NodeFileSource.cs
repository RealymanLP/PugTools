...
namespace PugTools {
  internal class NodeFileSource {
    internal Dictionary<String, List<NodeFileSourceItem>> sources =
      new Dictionary<String, List<NodeFileSourceItem>>();

    internal NodeFileSource() {
      //Tuple<string, string>[] strItems;

      List<NodeFileSourceItem> strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("ablIconSpec", "icon")
      };
      sources.Add("abl.", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("achIcon", "icon")
      };
      sources.Add("ach.", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("achCategoriesIcon", "icon"),
        new NodeFileSourceItem("achCategoriesCodexIcon", "icon")
      };
      sources.Add("achCategoriesTable_Prototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("4611686300283124000", "cnv")
      };
      sources.Add("arbSkirmishTable_Prototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("4611686299377594005", "fx"),
        new NodeFileSourceItem("4611686299377594006", "fx")
      };
      sources.Add("BlasterVisual_", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("/", "fx")
      };
      sources.Add("bom_", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("scFFComponentIcon", "icon")
      };
      sources.Add("capacitor_", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("cdxImage", "codex")
      };
      sources.Add("cdx.", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("chrBgDataIcon", "icon")
      };
      sources.Add("chrBackgroundTablePrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("chrCompanionInfo_portrait", "gfximg")
      };
      sources.Add("chrCompanionInfo_Prototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("chrSpecString", "spec")
      };
      sources.Add("chrSpecPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("colCollectionCategoryIcon", "icon")
      };
      sources.Add("colCollectionCategoriesPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("colCollectionIcon", "icon")
      };
      sources.Add("colCollectionItemsPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("classIcon", "icon")
      };
      sources.Add("dis.", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("/", "fxgr2")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("effAppParam_CasterAnim", "anim"),
        new NodeFileSourceItem("effAppParam_TargetAnim", "anim"),
        new NodeFileSourceItem("effAppParam_fxSpec", "fx")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("string", "icon")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("hydAction", "string")
      };
      sources.Add("hyd.", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("hydAnimationAction", "anim")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("itmIcon", "icon")
      };
      sources.Add("itm.", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("itmModel", "gr2"),
        new NodeFileSourceItem("itmFxSpec", "fx")
      };
      sources.Add("itmAppearanceDatatable", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("itmEnhancementTypeIconAsset", "icon")
      };
      sources.Add("itmEnhancementInfoPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("4611687146302020013", "icon")
      };
      sources.Add("lgcPerkPrototypeMap", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("4611686334119970107", "icon")
      };
      sources.Add("lgcUnlockPrototypeMap", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("ldgScreenName", "load"),
        new NodeFileSourceItem("ldgOverlayName", "load")
      };
      sources.Add("loadingAreaLoadScreenPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("tipIcon", "tip")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("mntDataVFX", "gr2")
      };
      sources.Add("mntMountInfoPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("mtxStorefrontIcon", "icon")
      };
      sources.Add("mtxStorefrontInfoPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("plcModel", "gr2")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("qstMissionIcon", "icon")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("4611686297701794045", "icon"),
        new NodeFileSourceItem("4611686297701794046", "icon")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("scFFCrewIcon", "icon"),
        new NodeFileSourceItem("4611686300849694002", "anim")
      };
      sources.Add("scffCrewPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("/", "gr2")
      };
      sources.Add("scFFDronesDataPrototype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("scFFPatternIcon", "icon")
      };
      sources.Add("scFFPatternsDefinitionProtoype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("/", "dds")
      };
      sources.Add("scFFPatternsTextureDataProtoype", strItems);

      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("scFFShipModel", "gr2"),
        new NodeFileSourceItem("scFFShipHullIcon", "icon"),
        new NodeFileSourceItem("scFFShipIcon", "icon")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("scEngineFXName", "fx")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("string", "string")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("vehAppModel", "gr2"),
        new NodeFileSourceItem("vehAppIdleAnimation", "anim")
      };
      ...
      strItems = new List<NodeFileSourceItem> {
        new NodeFileSourceItem("hydValue", "string")
      };
      sources.Add("cnv.", strItems);
    }
  }

  internal class NodeFileSourceItem {
    internal String field;
    internal String type;
    // public string skip;
    // public NodeFileSourceItem() { }

    internal NodeFileSourceItem(String field, String type) {
      this.field = field;
      this.type = type;
    }
