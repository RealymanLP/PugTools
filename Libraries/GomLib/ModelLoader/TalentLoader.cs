...
namespace GomLib.ModelLoader {
  public class TalentLoader {
    ...
    public Talent Load(Talent tal, GomObject obj) {
      ...
      tal.Name = tal.LocalizedName[GomLib.StringTable.SelectedLocalization];
      ...
      tal.Description = tal.LocalizedDescription[GomLib.StringTable.SelectedLocalization];
      ...
      foreach (GomObjectData statLookup in statLookupList) {
        ...
        foreach (GomObjectData defensiveStat in defensiveStatList) {//create a stat type that will hold the stat, the value, a bool, and the affected ability
      ...
      _dom.Assets.Icons.Add(tal.Icon);
    ...
    private static string ReplaceTokens(string desc, int _, string replacement) {
