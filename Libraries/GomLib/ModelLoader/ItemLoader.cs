...
namespace GomLib.ModelLoader {
  public class ItemLoader : IModelLoader {
    ...
    public Item Load(GameObject obj, GomObject gom) {
      ...
      itm.DetEnhancementType = _dom.EnhancementData.ToEnhancement(slotId);
      ...
      if (enhancementSlots != null) {
        for (var i = 0; i < 5; i++) {
          ...
          ItemEnhancement enh = new ItemEnhancement
            ...
            DetailedSlot = _dom.EnhancementData.ToEnhancement(slot),
      ...
      _dom.Assets.Icons.Add(itm.Icon);
      ...
      itm.Name = itm.LocalizedName[GomLib.StringTable.SelectedLocalization];
      ...
      if (schematic != null) {
        ...
        if (teachesType == "itmTeachesSchematic")
          ...
          itm.TeachesType = teachesType[10..];
        }
      }
      ...
      itm.EquipSetBonus = gom.Data.ValueOrDefault<long>("itmEquipSetBonus", 0);
