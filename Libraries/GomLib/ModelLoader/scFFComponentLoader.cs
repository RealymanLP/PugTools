...
namespace GomLib.ModelLoader {
  public class SCFFComponentLoader {
    ...
    public ScFFComponent Load(ScFFComponent cmp, GomObject obj) {
      ...
      if (controller != null) {
        ...
        if (gomStats != null) {
          ...
          foreach (var stat in statNames) {
            stringStats.TryGetValue(stat, out float value);
      ...
      _dom.Assets.Icons.Add(cmp.Icon);
      ...
      ScFFTalentTree scTree = new ScFFTalentTree
            {
        Tree = new Dictionary<int, Dictionary<int, List<object>>>()
      };
    ...
    private static void CheckAvailability(ScFFComponent cmp, ScriptEnum availability) {
