...
namespace GomLib.ModelLoader {
  public class EffectLoader : IModelLoader {
    ...
    public Effect Load(GameObject obj, GomObject gom) {
      ...
      if (effSubEffectEppDetails != null) {
        ...
        foreach (KeyValuePair<object, object> detail in effSubEffectEppDetails) {
          ...
          SubEffectEppDetail curDetail = new SubEffectEppDetail
                    {
            Index = (long)detail.Key,
            Dependent = tmpValue.ValueOrDefault<bool>("effSubEffectEppDependent"),
            EppSpec = tmpValue.ValueOrDefault<string>("effSubEffectEppSpec"),
            OnApply = tmpValue.ValueOrDefault<bool>("effSubEffectEppDetails")
          };
      ...
      if (eff.LocalizedName != null) eff.Name = eff.LocalizedName[GomLib.StringTable.SelectedLocalization];
      eff.LocalizedDescription = _dom.StringTable.TryGetLocalizedStrings("str.abl", eff.DescriptionStringId);
      if (eff.LocalizedDescription != null) eff.Description = eff.LocalizedDescription[GomLib.StringTable.SelectedLocalization];
