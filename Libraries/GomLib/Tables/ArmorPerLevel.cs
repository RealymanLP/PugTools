  ...
  public class ArmorPerLevel {
    ...
    public int GetArmor(ArmorSpec spec, int level, ItemQuality quality, SlotType slot) {
      ...
      if (table_data.ContainsKey(spec.Id)) {
        ...
        switch ((int)slot) {
          case 4: //EquipHumanWrist = 4,
          case 5: //EquipHumanBelt = 5,
          case 9: //EquipHumanFoot = 9,
          case 10: //EquipHumanGlove = 10,
            return 13;
          case 6: //EquipHumanChest = 6,
          case 8: //EquipHumanFace = 8,
          case 12: //EquipHumanLeg = 12,
            return 20;
          default:
            return -1;
        }
