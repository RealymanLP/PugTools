...
namespace GomLib.Models {
  public class Conquest : PseudoGameObject, IEquatable<Conquest> {
    ...
    public string HashedIcon {
      get {
        var fileId = TorArchive.FileId.FromFilePath(string.Format("/resources/gfx/codex/{0}.dds", Icon));
    ...
    public override int GetHashCode() {
      ...
      if (NewActiveData != null) foreach (var x in NewActiveData) { hash ^= x.GetHashCode(); }
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not Conquest itm) return false;
      ...
      if (NewObjectivesList.Count > 0) {
        ...
        foreach (var conquestObj in NewObjectivesList) {
          ...
          foreach (var achObj in conquestObj.Value) {
            oneTObjectives.Add(((Dom.GetObject(achObj) != null) ? Dom.AchievementLoader.Load(achObj) : new GameObject()).ToXElement(false));
          }
  ...
  public class ConquestObjective {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not ConquestObjective itm) return false;
  ...
  public class ConquestObjectivePackage : PseudoGameObject, IEquatable<ConquestObjectivePackage> {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not ConquestObjectivePackage itm) return false;
  ...
  public class Planet : GameObject, IEquatable<Planet> {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not Planet itm) return false;
  ...
  public class ConquestData : PseudoGameObject, IEquatable<ConquestData> {
    ...
    public Quest GuildQst {
      get {
        if (GuildQst_ == null) {
          GuildQst_ = Dom.QuestLoader.Load(GuildQstId);
        }
        return GuildQst_;
      }
    }
    ...
    public Quest PersonalQst {
      get {
        if (PersonalQst_ == null) {
          PersonalQst_ = Dom.QuestLoader.Load(PersonalQstId);
        }
        return PersonalQst_;
      }
    }
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not ConquestData itm) return false;
