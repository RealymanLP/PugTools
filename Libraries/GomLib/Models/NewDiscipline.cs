...
namespace GomLib.Models {
  public class NewDiscipline : GameObject, IEquatable<NewDiscipline> {
    [JsonIgnore]
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not Discipline obj2) return false;

      return Equals(obj2);
    }
    public bool Equals(NewDiscipline obj) {
      if (obj == null) return false;
    ...
    public override XElement ToXElement(bool verbose) {
      ...
      element.Add(new XAttribute("Id", Id),
          ...
          new XElement("DisciplinePath", PathAbilities != null ? PathAbilities.ToXElement(verbose) : null));
