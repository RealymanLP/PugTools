...
namespace GomLib.Models {
  public class Codex : GameObject, IEquatable<Codex> {
    ...
    public string Icon {
      get {
        var fileId = TorArchive.FileId.FromFilePath(string.Format("/resources/gfx/codex/{0}.dds", Image));
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not Codex cdx) return false;
    ...
    public override XElement ToXElement(bool verbose) //split to see if it was necessary to loop through linked codices. Didn't seem like it.
    {
      ...
      if (verbose) {
        ...
        codex.Add(new XElement("ClassRestricted", ClassRestricted),
            ...
            new XElement("Text", (LocalizedDescription != null ? LocalizedDescription[GomLib.StringTable.SelectedLocalization] : "")));
