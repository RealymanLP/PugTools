...
namespace GomLib.Models {
  ...
  public class ArmorSpec : PseudoGameObject, IEquatable<ArmorSpec> {
    ...
    private static Dictionary<long, ArmorSpec> _ArmorSpecList;
    public static Dictionary<long, ArmorSpec> ArmorSpecList {
      get => _ArmorSpecList;
      set => _ArmorSpecList = value;
    }
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not ArmorSpec obj2) return false;
    ...
    internal static ArmorSpec Load(ArmorSpec itm, GomObjectData gom) {
      ...
      itm.LocalizedName = itm.Dom.StringTable.TryGetLocalizedStrings("str.gui.tooltips", itm.NameId);
      itm.Name = itm.Dom.StringTable.TryGetString("str.gui.tooltips", itm.NameId);
