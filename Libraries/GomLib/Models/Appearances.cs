...
namespace GomLib.Models {
  public class AppSlot : PseudoGameObject, IEquatable<AppSlot> {
    ...
    public AMIEntry AMI {
      get {
        if (_AMI == null)
          _AMI = Dom.Ami.Find(Type, ModelID);
        return _AMI;
      }
    }
    ...
    private AMIEntry PrimaryAMI {
      get {
        if (_PrimaryAMI == null)
          _PrimaryAMI = Dom.Ami.Find("garmenthue", PrimaryHueId);
        return _PrimaryAMI;
      }
    }
    [JsonIgnore]
    ...
    private AMIEntry SecondaryAMI {
      get {
        if (_SecondaryAMI == null)
          _SecondaryAMI = Dom.Ami.Find("garmenthue", SecondaryHueId);
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not AppSlot aps) return false;
  ...
  public class ItemAppearance : GameObject, IEquatable<ItemAppearance> {
    ...
    public HashSet<string> GetAttachedFX() {
      ...
      foreach (var mod in IPP.AttachedModels) {
        try {
          ...
          // One malformed appearance must not abort the complete extraction.
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not ItemAppearance ipp) return false;
  ...
  public class NpcAppearance : GameObject, IEquatable<NpcAppearance> {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not NpcAppearance npp) return false;
    ...
    public bool Equals(NpcAppearance npp) {
      ...
      if (AppearanceSlotMap != null) {
        ...
        foreach (var appearance in AppearanceSlotMap) {
          _ = new List<AppSlot>();
          npp.AppearanceSlotMap.TryGetValue(appearance.Key, out List<AppSlot> prevApp);
  ...
  public class WeaponAppearance : PseudoGameObject, IEquatable<WeaponAppearance> {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not WeaponAppearance wpp) return false;
