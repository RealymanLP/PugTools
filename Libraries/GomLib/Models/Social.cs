    ...
    public SocialTier ToTier(int id) {
      if (SocialTierLookup == null) {
        ...
        for (int i = 0; i < chrSocialScoreTiers.Count; i++) {
          ...
          socTier.AchieveMessage = socTier.LocalizedName[GomLib.StringTable.SelectedLocalization];
        ...
        outcast.Name = outcast.LocalizedName[GomLib.StringTable.SelectedLocalization];
      ...
      if (!SocialTierLookup.ContainsKey(id)) { return null; } else { return SocialTierLookup[id]; }
    }
  }
