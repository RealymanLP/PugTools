...
namespace GomLib.Models {
  public class MtxStorefrontEntry : PseudoGameObject, IEquatable<MtxStorefrontEntry> {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not MtxStorefrontEntry mtx) return false;
    ...
    public override XElement ToXElement(bool verbose) {
      ...
      if (Unknowntext != "") { mtxStorefrontEntryXE.Add(new XElement("Unknown", Unknowntext)); } else { mtxStorefrontEntryXE.Add(new XElement("Unknown")); }
