...
namespace GomLib.Models {
  ...
  public static class WeaponSpecExtensions
  {
      ...
      public static WeaponSpec ToWeaponSpec(ulong val)
      {
          ...
          switch (val)
          {
              ...
              default:
                  Debug.WriteLine("Unknown WeaponSpec: " + val);
  ...
  public class WeaponSpec {
    ...
    public static Dictionary<System.UInt64, WeaponSpec> WeaponSpecList { get => weaponSpecList; set => weaponSpecList = value; }

    private static Dictionary<ulong, WeaponSpec> weaponSpecList;
    ...
    public static WeaponSpec Load(DataObjectModel dom, ulong id) {
      ...
      Load(dom);
      WeaponSpecList.TryGetValue(id, out WeaponSpec ret);
