...
namespace GomLib.Models {
  public class Npc : GameObject, IEquatable<Npc> {
    ...
    public List<string> AbilityPackageB62IdList {
      get {
        if (AbilityPackageB62IdList_ == null) {
          if (AbilityPackageIdList != null) {
            AbilityPackageIdList.Add(ClassSpec.AbilityPackageId);
            AbilityPackageB62IdList_ = AbilityPackageIdList.ToMaskedBase62();
          }
        }
        return AbilityPackageB62IdList_;
      }
    }
    ...
    public string CnvB62 {
      get {
        if (_cnvB62 == null) {
          var obj = Dom_.GetObject(CnvConversationName);
          if (obj != null) {
    ...
    public Codex Codex {
      get {
        if (CodexId != 0)
          return Dom_.CodexLoader.Load(CodexId);
        else
          return null;
      }
    }
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not Npc npc) return false;
    ...
    public override string ToString() {
      ...
      if (Codex != null) {
        txtFile.Append("  Codex: " + Codex.Fqn.ToString() + ": " + Codex.LocalizedName[GomLib.StringTable.SelectedLocalization] + n);
      }
    ...
    public override XElement ToXElement(bool verbose) {
      ...
      if (Codex != null) {
        codexFQN = Codex.Fqn;
        codexTitle = Codex.LocalizedName[GomLib.StringTable.SelectedLocalization];
      }

      if (Conversation != null) {
        _ = Conversation.Id.ToString();
        _ = CnvConversationName;
      }
