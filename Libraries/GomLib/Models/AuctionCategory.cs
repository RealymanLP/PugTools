...
namespace GomLib.Models {
  ...
  public class AuctionCategory : PseudoGameObject, IEquatable<AuctionCategory> {
    ...
    private static Dictionary<long, AuctionCategory> _AuctionCategoryList;
    public static Dictionary<long, AuctionCategory> AuctionCategoryList {
      get => _AuctionCategoryList;
      set => _AuctionCategoryList = value;
    }
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not AuctionCategory obj2) return false;
    ...
    internal static AuctionCategory Load(AuctionCategory itm, GomObjectData gom) {
      ...
      itm.LocalizedName = itm.Dom.StringTable.TryGetLocalizedStrings("str.gui.auctionhouse", itm.NameId);
      if (itm.NameId == 0)
        itm.Name = "Root";
      else
        itm.Name = itm.Dom.StringTable.TryGetString("str.gui.auctionhouse", itm.NameId);
      ...
      foreach (var obj in subCats) {
        AuctionSubCategory.Load(itm.Dom);
  ...
  public class AuctionSubCategory : PseudoGameObject, IEquatable<AuctionSubCategory> {
    ...
    private static Dictionary<int, AuctionSubCategory> _AuctionSubCategoryList;
    public static Dictionary<int, AuctionSubCategory> AuctionSubCategoryList {
      get => _AuctionSubCategoryList;
      set => _AuctionSubCategoryList = value;
    }
    private static Dictionary<long, AuctionSubCategory> _AuctionSubCategorySIdList;
    public static Dictionary<long, AuctionSubCategory> AuctionSubCategorySIdList {
      get => _AuctionSubCategorySIdList;
      set => _AuctionSubCategorySIdList = value;
    }
    public static void Flush() {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not AuctionSubCategory obj2) return false;
    ...
    internal static AuctionSubCategory Load(AuctionSubCategory itm, long nameId) {
      ...
      GomObject gom = itm.Dom.GetObject("ahItemSlotCategoriesPrototype");
      if (gom != null) {
        ...
        if (ahItemSlotCategories.ContainsKey(itm.Id)) {
          foreach (ScriptEnum obj in (List<ScriptEnum>)ahItemSlotCategories[itm.SId]) {
            if (!AuctionItemSlot.AuctionItemSlotList.TryGetValue(obj.ToString(), out AuctionItemSlot sub))
              sub = new AuctionItemSlot(itm.Dom, obj.ToString(), (long)(ahItemSlotConSlotNameIds[obj.ToString()]));
  ...
  public class AuctionItemSlot : IEquatable<AuctionItemSlot> {
    ...
    private static Dictionary<string, AuctionItemSlot> _AuctionItemSlotList = new Dictionary<string, AuctionItemSlot>();
    public static Dictionary<string, AuctionItemSlot> AuctionItemSlotList {
      get => _AuctionItemSlotList;
      set => _AuctionItemSlotList = value;
    }
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not AuctionItemSlot obj2) return false;
