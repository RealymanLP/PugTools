...
namespace GomLib.Models {
  public class ScFFComponent : GameObject, IEquatable<ScFFComponent> {
    ...
    public override bool Equals(object obj) {
      ...
      if (obj is not ScFFComponent scp) return false;
    ...
    public XElement ToXElement(bool isDefault, bool verbose) {
      XElement component = new XElement(
                "Component"
            );
      if (verbose) component.Add(
          new XElement(
              "Fqn",
              Fqn
          ),
      ...
      component.Add(
          ...
          new XElement("HashedIcon", HashedIcon),
          new XElement(
              "IsDefault",
              isDefault
          )
