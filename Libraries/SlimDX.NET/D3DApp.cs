...
namespace SlimDXNet {
  ...
  public class D3DApp : DisposableClass {
    ...
    public static D3DApp GD3DApp { get => gD3DApp; set => gD3DApp = value; }
    ...
    protected D3DApp(IntPtr hInstance, Form form = null) {
      AppInst = hInstance;
