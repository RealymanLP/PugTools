...
namespace Be.Windows.Forms {
  ...
  public class HexBox : Control {
    ...
    class KeyInterpreter : IKeyInterpreter {
      ...
      public virtual bool PreProcessWmKeyDown(ref Message m) {
        ...
        MessageDelegate messageHandler = hasMessageHandler
                    ...
                    : _ = new MessageDelegate(PreProcessWmKeyDown_Default);
    ...
    byte[] GetCopyData() {
      if (!CanCopy()) return Array.Empty<Byte>();
    ...
    public IByteProvider ByteProvider {
      ...
      set {
        ...
        if (value == null) // do not raise events if value == null
        {
          _bytePos = -1;
          _byteCharacterPos = 0;
          _selectionLength = 0;
    ...
    /// <summary>
    /// Gets or sets the info color used for column info and line info. When this property == null, then ForeColor property is used.
    /// </summary>
    [DefaultValue(typeof(Color), "Gray"), Category("Hex"), Description("Gets or sets the line info color. When this property == null, then ForeColor property is used.")]
