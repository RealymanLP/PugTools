...
namespace BrightIdeasSoftware {
  ...
  internal static class NativeMethods {
    ...
    /// </remarks>
    /// <param name="lv"></param>
    /// <param name="image">The image to be used as the background. If this == null, any existing background image will be cleared.</param>
    ...
    public static Rectangle GetUpdateRect(Control cntl) {
      ...
      _ = GetUpdateRectInternal(cntl.Handle, ref r, false);
      return r;
    }
