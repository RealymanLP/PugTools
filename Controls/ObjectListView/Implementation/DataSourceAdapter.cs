...
namespace BrightIdeasSoftware {
  ...
  public class DataSourceAdapter : IDisposable {
    ...
    protected virtual void CurrencyManagerListChanged(object sender, ListChangedEventArgs e) {
      ...
      //Debug.WriteLine(e.ListChangedType);
      ...
      //sw.Stop();
      //Debug.WriteLine(String.Format("Processing {0} event on {1} rows took {2}ms", e.ListChangedType, this.ListView.GetItemCount(), sw.ElapsedMilliseconds));
    ...
    protected virtual void HandleListChangedItemChanged(ListChangedEventArgs e) {
      ...
      //Debug.WriteLine(String.Format("HandleListChangedItemChanged: {0}, {1}", e.NewIndex, e.PropertyDescriptor.Name));
