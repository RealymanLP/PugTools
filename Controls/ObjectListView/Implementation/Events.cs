...
namespace BrightIdeasSoftware {
  ...
  public partial class ObjectListView {
    ...
    protected virtual void OnAboutToCreateGroups(CreateGroupsEventArgs e) {
      AboutToCreateGroups?.Invoke(this, e);
    }
    ...
    protected virtual void OnBeforeCreatingGroups(CreateGroupsEventArgs e) {
      BeforeCreatingGroups?.Invoke(this, e);
    }
    ...
    protected virtual void OnAfterCreatingGroups(CreateGroupsEventArgs e) {
      AfterCreatingGroups?.Invoke(this, e);
    }
    ...
    protected virtual void OnCellEditorValidating(CellEditEventArgs e) {
      ...
      //Debug.WriteLine(Environment.TickCount - lastValidatingEvent);
  ...
  public class CellEventArgs : EventArgs {
    ...
    /// </summary>
    /// <remarks>This == null for events triggered by the header.</remarks>
    public object Model {
      get { return model; }
    ...
    /// </summary>
    /// <remarks>This == null when the view is not in details view.</remarks>
    public OLVColumn Column {
      get { return column; }
    ...
    /// </summary>
    /// <remarks>This == null when the view is not in details view and 
  ...
  public class GroupExpandingCollapsingEventArgs : CancellableEventArgs {
    ...
    public GroupExpandingCollapsingEventArgs(OLVGroup group) {
      olvGroup = group ?? throw new ArgumentNullException(nameof(group));
    }
  ...
  public class TreeBranchCollapsingEventArgs : CancellableEventArgs {
    ...
    /// <summary>
    /// Gets the model that is about to collapse. If this == null, all models are going to collapse.
    /// </summary>
    public object Model {
      get { return model; }
      private set { model = value; }
