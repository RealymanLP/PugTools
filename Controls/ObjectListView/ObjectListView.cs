...
namespace BrightIdeasSoftware {
  ...
  public partial class ObjectListView : ListView, ISupportInitialize {
    ...
    /// <summary>
    /// Gets or sets the string that will be used to title groups when the group key == null.
    ...
    /// </summary>
    /// <param name="collection"></param>
    /// <returns>True if the given collection == null or empty</returns>
    /// <remarks>
    /// <para>When we move to .NET 3.5, we can use LINQ and not need this method.</para>
    /// </remarks>
    ...
    /// <summary>
    /// If AlwaysGroupByColumn != null, this property will be used to decide how
    ...
    public CellEditKeyEngine CellEditKeyEngine {
      get { return cellEditKeyEngine ??= new CellEditKeyEngine(); }
    ...
    internal static EditorRegistry EditorRegistry = new EditorRegistry();
    ...
    /// </summary>
    /// <remarks>If this == null, no filter menu will be built.</remarks>
    [Browsable(false),
    DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    [Category("ObjectListView"),
     ...
     DefaultValue(null)]
    new public ImageList GroupImageList {
    ...
    public HeaderControl HeaderControl {
      get { return headerControl ??= new HeaderControl(this); }
    }
    ...
    protected Dictionary<object, CheckState> CheckStateMap {
      get { return checkStateMap ??= new Dictionary<object, CheckState>(); }
...
#pragma warning restore
    ...
    /// is active (i.e. if PrimarySortColumn != null). Otherwise, they will appear at the end of the list.</para>
    ...
    /// <remarks>
    /// <para>
    /// If the AlwaysGroupByColumn property != null,
    ...
    /// If the given item == null, the first item in the list will be returned.
    ...
    /// If the given item == null, the last item in the list will be returned.
    ...
    protected OlvListViewHitTestInfo LowLevelHitTest(int x, int y) {
      ...
      // Debug.WriteLine(String.Format("HitTest({0}, {1})=>{2}", x, y, olvListViewHitTest));
    ...
    private void HandleModelOnPropertyChanged(object sender, PropertyChangedEventArgs propertyChangedEventArgs) {
      // Debug.WriteLine(String.Format("PropertyChanged: '{0}' on '{1}", propertyChangedEventArgs.PropertyName, sender));
    ...
    */
    ...
    protected virtual bool HandleBeginScroll(ref Message m) {
      //Debug.WriteLine("LVN_BEGINSCROLL");
    ...
    protected virtual bool HandleLinkClick(ref Message m) {
      //Debug.WriteLine("HandleLinkClick");
    ...
    protected virtual bool HandleCustomDraw(ref Message m) {
      ...
      //Debug.WriteLine(String.Format("cd: {0:x}, {1}, {2}", nmcustomdraw.nmcd.dwDrawStage, nmcustomdraw.dwItemType, nmcustomdraw.nmcd.dwItemSpec));
      ...
      switch (nmcustomdraw.nmcd.dwDrawStage) {
        ...
        case CDDS_POSTPAINT:
          //Debug.WriteLine("CDDS_POSTPAINT");
          prePaintLevel--;
        ...
        case CDDS_ITEMPOSTPAINT:
          //Debug.WriteLine("CDDS_ITEMPOSTPAINT");
        ...
        case CDDS_SUBITEMPREPAINT:
          //Debug.WriteLine(String.Format("CDDS_SUBITEMPREPAINT ({0},{1})", (int)nmcustomdraw.nmcd.dwItemSpec, nmcustomdraw.iSubItem));
        ...
        case CDDS_SUBITEMPOSTPAINT:
          //Debug.WriteLine("CDDS_SUBITEMPOSTPAINT");
          break;
        ...
        case CDDS_PREERASE:
          //Debug.WriteLine("CDDS_PREERASE");
          break;

        case CDDS_POSTERASE:
          //Debug.WriteLine("CDDS_POSTERASE");
          break;

        case CDDS_ITEMPREERASE:
          //Debug.WriteLine("CDDS_ITEMPREERASE");
          break;

        case CDDS_ITEMPOSTERASE:
          //Debug.WriteLine("CDDS_ITEMPOSTERASE");
          break;
      }
    ...
    protected virtual bool HandleGroupInfo(ref Message m) {
      ...
      //Debug.WriteLine(String.Format("group: {0}, old state: {1}, new state: {2}",
    ...
    protected virtual bool HandleReflectNotify(ref Message m) {
      ...
      //Debug.WriteLine(String.Format("rn: {0}", nmhdr->code));
      ...
      switch (nmhdr.code) {
        ...
        case LVN_MARQUEEBEGIN:
          //Debug.WriteLine("LVN_MARQUEEBEGIN");
          isMarqueSelecting = true;
          break;

        case LVN_GETINFOTIP:
          //Debug.WriteLine("LVN_GETINFOTIP");
        ...
        case NM_RELEASEDCAPTURE:
          //Debug.WriteLine("NM_RELEASEDCAPTURE");
          isMarqueSelecting = false;
          Invalidate();
          break;

        case NM_CUSTOMDRAW:
          //Debug.WriteLine("NM_CUSTOMDRAW");
        ...
        case LVN_ITEMCHANGED:
          //Debug.WriteLine("LVN_ITEMCHANGED");
        ...
        case LVN_ITEMCHANGING:
          //Debug.WriteLine("LVN_ITEMCHANGING");
        ...
        case LVN_GROUPINFO:
          //Debug.WriteLine("reflect notify: GROUP INFO");
          isMsgHandled = HandleGroupInfo(ref m);
          break;

          //default:
          //Debug.WriteLine(String.Format("reflect notify: {0}", nmhdr.code));
          //break;
      }
    ...
    protected bool HandleNotify(ref Message m) {
      ...
      //Debug.WriteLine(String.Format("not: {0}", nmhdr->code));

      //if (nmhdr.code < HDN_FIRST)
      //    Debug.WriteLine(nmhdr.code);
    ...
    /// </summary>
    internal static Bitmap SortAscendingImage = Properties.Resources.SortAscending;

    /// <summary>
    /// Gets or sets the image that will be placed next to the Sort Descending command
    /// </summary>
    internal static Bitmap SortDescendingImage = Properties.Resources.SortDescending;
    ...
    public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex) {
      ...
      if (column.Sortable && !string.IsNullOrEmpty(label)) {
        strip.Items.Add(label, SortAscendingImage, delegate (object sender, EventArgs args) {
          Sort(column, SortOrder.Ascending);
        });
      }
      label = string.Format(MenuLabelSortDescending, column.Text);
      if (column.Sortable && !string.IsNullOrEmpty(label)) {
        strip.Items.Add(label, SortDescendingImage, delegate (object sender, EventArgs args) {
      ...
      if (CanShowGroups) {
        ...
        if (column.Groupable && !string.IsNullOrEmpty(label)) {
          strip.Items.Add(label, null, delegate (object sender, EventArgs args) {
            ShowGroups = true;
    ...
    public virtual void EnsureGroupVisible(ListViewGroup lvg) {
      ...
      if (groupIndex <= 0) {
        ...
        ListViewItem lastItemInGroup = previousGroup.Items[^1];
    ...
    /// If AlwaysGroupsByColumn != null, the rows will be grouped by that column,
    ...
    private void ApplyHyperlinkStyle(int _, OLVListItem olvi) {
...
#pragma warning restore
    ...
    /// If source == null, an empty image list of the given size is returned
    /// </summary>
    ...
    protected override void OnDrawSubItem(DrawListViewSubItemEventArgs e) {
      //Debug.WriteLine(String.Format("OnDrawSubItem ({0}, {1})", e.ItemIndex, e.ColumnIndex));
    ...
    //    Debug.WriteLine(String.Format("OnMouseHover"));
    //    base.OnMouseHover(e);
    ...
    protected override void OnMouseMove(MouseEventArgs e) {
      ...
      //Debug.WriteLine(String.Format("MouseMove: {0}", e.Location));
...
#pragma warning restore
    ...
    protected Rectangle CalculateCellEditorBoundsOwnerDrawn(OLVListItem item, int subItemIndex, Rectangle r, Size preferredSize) {
      ...
      using Graphics g = CreateGraphics(); return renderer.GetEditRectangle(g, r, item, subItemIndex, preferredSize);
    }
    ...
    /// <param name="preferredSize"> </param>
    /// <returns>A rectangle that is the bounds of the cell editor</returns>
    protected Rectangle CalculateCellEditorBoundsStandard(OLVListItem item, int subItemIndex, Rectangle cellBounds, Size _) {
      if (View != View.Details)
        return cellBounds;
    ...
    protected virtual object GetControlValue(Control control) {
      ...
      if (control is ComboBox box1)
        return box1.SelectedValue;

      if (control is CheckBox box2)
        return box2.Checked;
