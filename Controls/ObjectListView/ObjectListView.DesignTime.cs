  ...
  public class ObjectListViewDesigner : ControlDesigner {
    ...
    private class ListViewActionListAdapter : DesignerActionList {
      ...
      public ImageList LargeImageList {
        ...
        set { SetValue(Component, nameof(LargeImageList), value); }
      }

      public ImageList SmallImageList {
        get { return ((ListView)Component).SmallImageList; }
        set { SetValue(Component, nameof(SmallImageList), value); }
      }

      public View View {
        get { return ((ListView)Component).View; }
        set { SetValue(Component, nameof(View), value); }
      }

      readonly ObjectListViewDesigner designer;
      readonly DesignerActionList wrappedList;
    }
