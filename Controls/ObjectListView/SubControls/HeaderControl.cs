...
namespace BrightIdeasSoftware {
  ...
  public class HeaderControl : NativeWindow {
    ...
    internal virtual bool HandleHeaderCustomDraw(ref Message m) {
      ...
      //Debug.WriteLine(String.Format("header cd: {0:x}, {1}, {2:x}", nmcustomdraw.dwDrawStage, nmcustomdraw.dwItemSpec, nmcustomdraw.uItemState));
